...
extension RegistryService {
    ...
    static let cirrusLabsCatalogue: [CirrusLabsImage] = [
        ...
        CirrusLabsImage(id: "ghcr.io/cirruslabs/macos-golden-gate-vanilla:latest",
            imageRef: "ghcr.io/cirruslabs/macos-golden-gate-vanilla:latest",
            os: "macOS 27 Golden Gate", variant: "Vanilla",
            description: "A vanilla macOS installation with helpful tweaks such as auto-login, but no additional software preinstalled."),
        CirrusLabsImage(id: "ghcr.io/cirruslabs/macos-golden-gate-base:latest",
            imageRef: "ghcr.io/cirruslabs/macos-golden-gate-base:latest",
            os: "macOS 27 Golden Gate", variant: "Base",
            description: "Based on the vanilla image. Includes Homebrew, Git, common build tools. No Xcode, though."),
        // macOS 26 Tahoe
        ...
        CirrusLabsImage(id: "ghcr.io/cirruslabs/macos-tahoe-xcode:latest",
            ...
            description: "Base + Flutter + Xcode."),
        // macOS 15 Sequoia
